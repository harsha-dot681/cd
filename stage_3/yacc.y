...
%token T_BEGIN T_END T_READ T_WRITE T_IF T_ENDIF T_then T_ELSE T_WHILE T_DO T_ENDWHILE LE GE NE EQ
%nonassoc T_then
%nonassoc T_ELSE
%token<no>number ID
...
%left '*' '/'
%%
program: T_BEGIN Slist T_END {eval($2);exit(0);}| T_BEGIN T_END {$$=NULL;}
;
Slist : Slist Stmt{$$=makeStmtNode(STATEMENT,$1,$2,"STATEMENTS");} |Stmt {$$=$1;}
;
Stmt : T_READ '('ID')'';' {$$=makeStmtNode($3->type,$3,NULL,"read");}| T_WRITE '('E')'';' {$$=makeStmtNode($3->type,$3,NULL,"write");} |ID '=' E';'{$$=makeExprNode($1->type,"=",$1,$3,"=");}|Ifstmt';'{$$=$1;}|Whilestmt';'{$$=$1;}
;
